  ...
  return (
    <div>
      <h2 className="pt-4 mt-4 pb-4 mb-4  motiveh1">
        <b>Top Searched Courses</b>
      </h2>
      <div className="pt-4 mt-4 pb-4 mb-4 d-flex justify-content-center align-items-center ">
        <TabsUnstyled defaultValue={0}>
          <TabsList>
            <Tab>
              <ConnectedTvIcon className="me-2" />
              Online Coaching result
            </Tab>
            <Tab>
              <PeopleAltIcon className="me-2" />
              Offline Coaching result
            </Tab>
          </TabsList>
        </TabsUnstyled>
      </div>
