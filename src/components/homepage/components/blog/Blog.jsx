    ...
    <div>
      ...
      <div className=" blogmain">
        <MDBCard
          ...
          className="pt-4 mt-4 pb-4 mb-4 ms-4 me-4 blogcard"
        >
          <MDBRow className="g-0 ">
            ...
            <MDBCol md="8">
              <MDBCardBody>
                <MDBCardTitle className=" blogtitle">
                  September 20, 2021
                </MDBCardTitle>
                <MDBCardText className=" blogtext">
                  PPDT SSB -What it is all about?
                  <br />
                  PPDT In SSB In the Picture Perception and Discussion Test
                  (PPDT) at SSB
                </MDBCardText>
                <MDBCardText>
        ...
        <Col xs="auto">
          <div className=" pt-1 mt-1 pb-1 mb-1 d-flex justify-content-center align-items-center">
            <Card style={{ width: "16rem" }} className="cardblog">
              <Card.Img
                variant="top"
                src="./imgs/courses/rau.png"
                alt="rau acadamy"
              />
              <hr className="greenline" />
              <Card.Body>
                <Card.Title>
                  <b>Rau's IAS Study Circle</b>
                </Card.Title>
                <Card.Subtitle className="mb-2 text-muted">
                  New Delhi
                </Card.Subtitle>
                <Card.Text>UPSC | IAS | IAS GS</Card.Text>
                <div>
                  <Card.Text>
                    ...
                    <span className="bordericon">
                      <PersonOutlineIcon className="ms-2 " /> 25000
                    </span>
                  </Card.Text>
                </div>
              </Card.Body>
