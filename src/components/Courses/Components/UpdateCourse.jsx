    ...
    try {
        axios(
          ...
          withCredentials: true
            ...
            fieldChanged("coursePrerequisite",response.data.result.CoursePrerequisite)
            ...
            for(let i=0;i<response.data.secDT.length;i++){
                setSectionField([...sectionField,{SectionName:response.data.secDT[i],lectureNo:response.data.lecData[i]}])
                ...
                for (let j = 0; j < response.data.lecData[i]; j++) {
                    fieldChanged(`lectureName${i}${j}`,response.data.secData[cnt].VideoName);
                    fieldChanged(`lectureDesc${i}${j}`,response.data.secData[cnt].LectureDesc);
                    fieldChanged(`lectureVideo${i}${j}`,response.data.secData[cnt].LectureVideo.secure_url);
                    fieldChanged(`lectureResource${i}${j}`,response.data.secData[cnt].LectureResourceFile.secure_url);
            ...
            fieldChanged("landingPageSubTitle",response.data.resultMore.CourseSubTitle);
            ...
            fieldChanged("courseDifficulty",response.data.resultMore.DifficultyLevel);
            fieldChanged("landingPageCategory",response.data.resultMore.CourseCategory);
            fieldChanged("landingPageLearning",response.data.resultMore.CourseLearing);
            ...
            fieldChanged("courseImage",response.data.resultMore.CourseImg.secure_url);
            fieldChanged("coursePromo",response.data.resultMore.CoursePromo.secure_url);
        })
