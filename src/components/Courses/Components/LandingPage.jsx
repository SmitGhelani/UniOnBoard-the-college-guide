...
export default function LandingPage() {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        setCourseImgURL(
          response.data.data.landingPageData.CourseImg.secure_url
        );
    ...
    try {
      ...
      if (resultPayment) {
        ...
        var options = {
          ...
          image:
            "https://res.cloudinary.com/dkmj6cid2/image/upload/v1650521502/samples/ecommerce/logoPayment_lzteq4.png",
  ...
  return (
    <LoadingOverlay active={isActive} spinner text="Loading Please wait...">
        ...
        <div className="mainPanel">
          <div className="subMainPanel">
            ...
            <div className="authorImg">
              <div className="box">
                ...
                <div className="column">
                  <label className="authorName">{authorData.name}</label>
                  <label className="authorMail">{authorData.email}</label>
                </div>
              </div>
            ...
            <div className="coursePromoLandingDiv">
              <video
                className="coursePromoLandingPage"
                src={promoURL}
                controls
                muted
                autoPlay
          ...
          <div className="sidePanel">
            <div className="sidebarHeading">Course Basics</div>
            <hr />
            ...
            <div className="enrollButton">
              {isPaymentDone === false && (
                <button
                  id={"enroll-corse"}
                  className="button"
                  onClick={(e) => onEnroll(e)}
                >
                  Enroll Today
                </button>
              )}
              {isPaymentDone && (
                <Link to={`/courses/watchCourse/${id}`}>
                  <button className="button">Visit Course</button>
                </Link>
              )}
            </div>
          </div>
