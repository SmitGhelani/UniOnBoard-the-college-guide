  ...
  return (
    <div className="course">
      <Link to={`/courses/${courseId}`} className="link">
        ...
        <div className="coursePriceCard">&#8377;{coursePrice}</div>
      ...
      <div className="updateDeleteBtn">
        <Link to={`/updateYourCourse/${courseId}`} className="updateBtnLink">
          <button className="updateBtnProfile">
            <i className="updateCourseIconProfile fa-solid fa-pencil"></i>
          </button>
        </Link>
        <button
          className="deleteBtnProfile"
          onClick={(e) => deleteCourse(e, courseId)}
        >
          <i className="deleteCourseIconProfile fa-solid fa-trash"></i>
        </button>
      </div>
